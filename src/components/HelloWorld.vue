<template>
  <div class="hello">
    <div class="left">
      ...
      <ul>
        <li v-for="(link, index) in actorsArray" v-bind:key="index">
          {{ link }}
...
export default {
  ...
  fetchMaterial() {
        this.axios
          .get("https://griddata.herokuapp.com/materials/5b115222fb6fc07c033ca3a0")
          .then(res => {
            this.material = res.data.material;
            this.actorsArray = res.data.material.mainActors;
